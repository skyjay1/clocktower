...
public class ClockBlockEntityRenderer extends TileEntityRenderer<ClockBlockEntity> {
    ...
    public ClockBlockEntityRenderer(TileEntityRendererDispatcher rendererDispatcher) {
    ...
    @Override
    public void render(ClockBlockEntity blockEntity, float partialTicks, MatrixStack matrixStackIn, IRenderTypeBuffer bufferIn,
